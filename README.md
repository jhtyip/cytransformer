...
| Checkpoint | h11 | N_vert | Step | Vocab | Params | Val loss |
|---|---|---|---|---|---|---|
...
N_vert is written as *vertices + origin*: `9+1` is 9 polytope vertices plus the origin, i.e. 10 lattice
points, which is the paper's N_vert = 10.
